...
include 'session.php';
// Included to get Bursary_ID   from coversFor()
...
function editBursary(){
    ...
    $sql= "SELECT * FROM `sponsor_users` WHERE email_address = 'augustnoheart@godspeed.com'";
...
//=======================================WHAT A BURSARY COVERS FOR======================================================
    ...
    function bursaryCovers($result){
        ...
        */
        $sql2 = "SELECT * FROM `bursaries` WHERE Company_ID = '$result'"; //query bursaries table for Bursary_ID 
        ...
        if(!empty($chk)){
            $sql3 = "UPDATE bursary_covers SET Bursary_Covers='$chk' WHERE Bursary_ID = $bursary_id";
