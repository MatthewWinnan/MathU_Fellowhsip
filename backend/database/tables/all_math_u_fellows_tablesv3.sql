...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 06, 2021 at 12:32 PM
...
(4, 'Star Labs', '', 'Technology', 'The home of the flash', 'www.theflash.com', '2021-08-06', 0);
...
(3, 'S123', 'August', 'Heart', 'augustnoheart@godspeed.com', 'IamGodspeed', 4, 1, 1, 1, 1, 1, '2021-08-06', '2021-08-06'),
(4, 'S123', 'August', 'Heart', 'augustnoheart@godspeed.com', 'IamGodspeed', 4, 1, 1, 1, 1, 1, '2021-08-06', '2021-08-06');
...
INSERT INTO `student` (`ID`, `Student_ID`, `First_name`, `Last_name`, `Date_of_birth`, `Email_address`, `Password`, `Validated`, `Nationality`, `Contact_number`, `City`, `Province`, `Disability`, `Current_academic_level`, `Grade`, `Syllabus`, `Average`, `Currently_studying`, `Year_of_study`, `Study_institution`, `Continue_studies`, `GPA`, `Description_of_student`, `Registerred_date`, `Bursarred`, `Current_bursary/ies`, `Workback`, `Filters`, `Website`, `Last_login`, `Number_of_reports`, `Banned`) VALUES
(4, 'U123', 'Iris', 'West-Allen', '2021-08-06', 'weare@theflash.com', '$2y$10$s2c6r8TJBRIf0IvNhFFPeepV5RkaRf3ylgiT0mRoAg81y1dZeSb76', 1, 0, 0, '', '', 0, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '0000-00-00', 0, NULL, 0, '', '', '0000-00-00', 0, 0);
...
--
ALTER TABLE `sponsor_users`
  ADD CONSTRAINT `Constraint` FOREIGN KEY (`company_id`) REFERENCES `company` (`company_id`);
