...
//======================================
function DenyApplicant(int $id, int $b_id, $mysqli){
	$sql = "UPDATE student_bursary SET Status = 'Declined' WHERE Student_ID=$id AND Bursary_ID=$b_id";
	if ($mysqli->query($sql)=== TRUE){
		return true;
	}
	else return false;
...
//=========================================
function AcceptApplicant(int $id, int $b_id, $mysqli){
	$sql = "UPDATE student_bursary SET Status = 'Accepted' WHERE Student_ID=$id AND Bursary_ID=$b_id";
	if ($mysqli->query($sql)=== TRUE){
		return true;
	}
	else return false;
