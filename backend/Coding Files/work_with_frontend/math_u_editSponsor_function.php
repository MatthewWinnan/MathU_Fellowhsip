...
function ShortList(int $id, $mysqli){
	$sql = "UPDATE student_bursaries SET ShortListed = TRUE WHERE Student_ID=$id";
	if ($mysqli->query($sql)=== TRUE){
		return true;
	}
	else return false;
...
//======================================
function DenyApplicant(int $s_id, int $b_id, $mysqli){
	$sql = "UPDATE student_bursaries SET Status = 'Declined' WHERE Student_ID=$s_id AND Bursary_ID=$b_id";
	if ($mysqli->query($sql)=== TRUE){
		return true;
	}
	else return false;
...
//=========================================
function AcceptApplicant(int $s_id, int $b_id, $mysqli){
	$sql = "UPDATE student_bursaries SET Status = 'Accepted' WHERE Student_ID=$s_id AND Bursary_ID=$b_id";
	if ($mysqli->query($sql)=== TRUE){
		return true;
	}
	else return false;
